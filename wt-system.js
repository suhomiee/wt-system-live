...
(function () {
  ...
  function renderSourceFrame(source) {
    return [
      ...
      '</header>',
      '<div class="wt-embed-status"><b>External SharePoint embed may be blocked.</b><span>If the viewer stays blank, use Open SharePoint in a signed-in browser or paste a direct PDF URL.</span></div>',
